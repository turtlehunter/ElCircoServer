...
public class SmackCcsClient {
    ...
    public static ArrayList<String> toResend = new ArrayList<String>();
    ...
    public boolean sendDownstreamMessage(String jsonRequest) throws
        ...
        addToResend(jsonRequest);
        logger.info("Dropping downstream message since the connection is draining");
        return false;
    }

    private void addToResend(String jsonRequest) {
        toResend.add(jsonRequest);
    }
    ...
    protected void handleControlMessage(Map<String, Object> jsonObject) {
        ...
        if ("CONNECTION_DRAINING".equals(controlType)) {
            ...
            logger.log(Level.WARNING, "Unrecognized control type: %s. This could happen if new features are " + "added to the CCS protocol.",
                    controlType);
        }
    }
    ...
    public static void toSend(SmackCcsClient activeConnection) {
        ...
        while(it.hasNext()) {
            try {
                activeConnection.send((String) it.next());
            } catch (NotConnectedException e) {
                logger.log(Level.SEVERE, "We got disconectted!");
            } finally {
                it.remove();
            }
        }
